 ...
 * @since 3.8.0
 */
class WC_Authorize_Net_AIM_Emulation_API_Request implements Framework\SV_WC_Payment_Gateway_API_Request {
	...
	private function create_transaction( $type ) {
		...
		$this->request_data = array(
			...
			'x_currency_code' => Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'currency', 'view' ),
			...
			'x_email'         => is_email( Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'billing_email' ) ) ? Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'billing_email' ) : '',
			'x_cust_id'       => $this->order->get_user_id(),
			'x_customer_ip'   => Framework\SV_WC_Order_Compatibility::get_prop( $this->get_order(), 'customer_ip_address' ),
		);
	...
	private function set_addresses() {
		...
		$fields = array(
			'billing'  => array(
				'first_name'  => array( 'value' => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'billing_first_name' ),                                        'limit' => 50 ),
				'last_name'   => array( 'value' => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'billing_last_name' ),                                         'limit' => 50 ),
				...
				'phone'       => array( 'value' => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'billing_phone' ),                                             'limit' => 25 ),
			),
			'shipping' => array(
				'first_name' => array( 'value' => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'shipping_first_name' ),                                         'limit' => 50 ),
				'last_name'  => array( 'value' => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'shipping_last_name' ),                                          'limit' => 50 ),
