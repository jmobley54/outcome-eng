 ...
 * @since 3.8.0
 */
class WC_Authorize_Net_AIM_Emulation_API_Response implements Framework\SV_WC_Payment_Gateway_API_Response, Framework\SV_WC_Payment_Gateway_API_Authorization_Response {
	...
	protected function parse_response() {
		...
		if ( empty( $response ) ) {
			throw new Framework\SV_WC_Payment_Gateway_Exception( __( 'Could not parse direct response.', 'woocommerce-gateway-authorize-net-aim' ) );
		}
