 ...
 * @since 3.8.0
 */
class WC_Authorize_Net_AIM_API_Response_Message_Handler extends Framework\SV_WC_Payment_Gateway_API_Response_Message_Helper {
	 ...
	 * fishing for info. Overridden to add a few custom Authorize.Net-specific
	 * user error messages.
	 *
	 ...
	 * @since 3.8.0
	 *
	 * @param string $message_id ID of the message to return
	 * @return string
	 */
