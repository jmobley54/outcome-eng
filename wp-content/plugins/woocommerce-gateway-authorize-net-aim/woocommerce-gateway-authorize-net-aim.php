 ...
 * @since 3.14.0
 */
class WC_Authorize_Net_AIM_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Authorize.Net AIM Gateway';
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-authorize-net-aim.php' );
	...
	/**
	 * Displays any admin notices added with \WC_Authorize_Net_AIM_Loader::add_admin_notice()
	 *
	 * @since 3.14.0
	 */
	...
	/**
	 * Gets the main \WC_Authorize_Net_AIM_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 3.14.0
	 *
	 * @return \WC_Authorize_Net_AIM_Loader
	 */
...
// fire it up!
WC_Authorize_Net_AIM_Loader::instance();
