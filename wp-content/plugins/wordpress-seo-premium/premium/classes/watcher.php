...
abstract class WPSEO_Watcher {
	...
	public function page_scripts( $current_page ) {
		...
		wp_register_script(
			...
			plugin_dir_url( WPSEO_PREMIUM_FILE ) . 'assets/js/dist/wp-seo-premium-quickedit-notification-' . $version . WPSEO_CSSJS_SUFFIX . '.js',
			array(
				'jquery',
				'wp-api',
				'wp-api-fetch',
		...
		wp_register_script(
			...
			plugin_dir_url( WPSEO_PREMIUM_FILE ) . 'assets/js/dist/wp-seo-premium-redirect-notifications-' . $version . WPSEO_CSSJS_SUFFIX . '.js',
			array(
				'jquery',
				'wp-api',
				'wp-api-fetch',
		...
		wp_register_script(
			'wp-seo-premium-redirect-notifications-gutenberg',
			plugin_dir_url( WPSEO_PREMIUM_FILE ) . 'assets/js/dist/wp-seo-premium-redirect-notifications-gutenberg-' . $version . WPSEO_CSSJS_SUFFIX . '.js',
			array(
