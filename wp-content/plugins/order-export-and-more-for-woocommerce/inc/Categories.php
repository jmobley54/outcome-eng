...
class Categories extends BaseEntity{
	...
	private function load_fields(){
		...
		$fields['name'] = array(
			'name' => 'name',
			'placeholder' => __('Category Name', JEM_EXP_DOMAIN)	
		...
		$fields['desc'] = array(
				'name' => 'desc',
				'placeholder' => __('Category Description', JEM_EXP_DOMAIN)
		
		);
		
		$fields['slug'] = array(
				'name' => 'slug',
				'placeholder' => __('Category Slug', JEM_EXP_DOMAIN)
		...
		$fields['display'] = array(
				'name' => 'display',
				'placeholder' => __('Display Type', JEM_EXP_DOMAIN)
		
		);
		
		$fields['image'] = array(
				'name' => 'image',
				'placeholder' => __('Thumbnail Image', JEM_EXP_DOMAIN)
	...
	public function generate_filters($prefix=""){
		...
		$ret= '
			<div class="jemex-filter-section">
				...
				<p class="instructions">' . __('There are no filters for Categories.', JEM_EXP_DOMAIN) . '</p>
			</div>
