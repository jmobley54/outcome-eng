...
class Yoast_HelpScout_Beacon {
	...
	private function get_instructions() {
		$return  = __( "Please explain what you're trying to find or do. If something isn't working, please explain what you expect to happen. If you can make a screenshot, please attach it.", 'wordpress-seo-premium', 'yoast-video-seo' );
		$return .= ' ';
		$return .= __( 'Note: submitting this form also sends us debug info about your server.', 'wordpress-seo-premium', 'yoast-video-seo' );
	...
	private function get_translations() {
		return array(
			'searchLabel'               => __( 'What can we help you with?', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'searchErrorLabel'          => __( 'Your search timed out. Please double-check your internet connection and try again.', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'noResultsLabel'            => __( 'No results found for', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'contactLabel'              => __( 'Send a Message', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'attachFileLabel'           => __( 'Attach a file', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'attachFileError'           => __( 'The maximum file size is 10 MB', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'nameLabel'                 => __( 'Your Name', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'nameError'                 => __( 'Please enter your name', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'emailLabel'                => __( 'Email address', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'emailError'                => __( 'Please enter a valid email address', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'topicLabel'                => __( 'Select a topic', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'topicError'                => __( 'Please select a topic from the list', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'subjectLabel'              => __( 'Subject', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'subjectError'              => __( 'Please enter a subject', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'messageLabel'              => __( 'How can we help you?', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'messageError'              => __( 'Please enter a message', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'sendLabel'                 => __( 'Send', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'contactSuccessLabel'       => __( 'Message sent, thank you!', 'wordpress-seo-premium', 'yoast-video-seo' ),
			'contactSuccessDescription' => __( 'Someone from Team Yoast will get back to you soon, normally within a couple of hours.', 'wordpress-seo-premium', 'yoast-video-seo' ),
		);
	}
