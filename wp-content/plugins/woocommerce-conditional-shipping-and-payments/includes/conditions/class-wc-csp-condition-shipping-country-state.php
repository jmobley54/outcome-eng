...
class WC_CSP_Condition_Shipping_Country_State extends WC_CSP_Package_Condition {
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( isset( $args[ 'package' ] ) ) {
			...
			$state   = $args[ 'package' ][ 'destination' ][ 'state' ];
	...
	public function check_condition( $data, $args ) {
		...
		if ( $this->modifier_is( $data[ 'modifier' ], array( 'in' ) ) && in_array( $country, $data[ 'value' ] ) ) {
			...
			if ( ! in_array( $country, $data[ 'value' ] ) ) {
				return true;
			} elseif ( $state && in_array( $country, $data[ 'value' ] ) && ! empty( $data[ 'states' ][ $country ] ) && ! in_array( $state, $data[ 'states' ][ $country ] ) ) {
				return true;
			}
		}
	...
	public function get_admin_fields_html( $index, $condition_index, $condition_data ) {
		...
		<div class="condition_row_inner">
			...
			<div class="condition_value select-field">
				<select class="csp_shipping_countries multiselect wc-enhanced-select" name="restriction[<?php echo $index; ?>][conditions][<?php echo $condition_index; ?>][value][]" multiple="multiple" data-placeholder="<?php _e( 'Select shipping countries&hellip;', 'woocommerce-conditional-shipping-and-payments' ); ?>">
					<?php
		...
		<div class="condition_row_inner">
			...
			<div class="condition_value excluded_states select-field">
				<select class="csp_shipping_states multiselect wc-enhanced-select" name="restriction[<?php echo $index; ?>][conditions][<?php echo $condition_index; ?>][states][]" multiple="multiple" data-placeholder="<?php _e( 'Limit restriction to specific States/Regions?', 'woocommerce-conditional-shipping-and-payments' ); ?>">
					<?php
						if ( ! empty( $countries ) ) {
