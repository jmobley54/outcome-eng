<div class="ihc-subtab-menu">
	...
	<a class="ihc-subtab-menu-item" href="<?php echo $url.'&tab='.$tab.'&subtab=double_email_verification';?>"><?php _e('E-mail Verification', 'ihc');?></a>		
	<a class="ihc-subtab-menu-item" href="<?php echo $url.'&tab='.$tab.'&subtab=access';?>"><?php _e('Access', 'ihc');?></a>
...
switch ($subtab){
	...
	case 'access':
		...
		<form action="" method="post">
			<div class="ihc-stuffbox">
				<h3><?php _e('Roles allowed to enter into Admin Section:', 'ihc');?></h3>
				<div class="inside">
