...
switch ($subtab){
	...
	case 'custom_fields':
		...
		?>
			...
			?>
			<a href="<?php echo $add_new_lnk;?>" class="indeed-add-new-like-wp <?php echo $disabled_lnk;?>" style="display: inline-block; margin: 10px 0px;"><?php 
				_e('Add New Register Form Field', 'ihc');
			?></a>	
			<div class="clear"></div>
			<form action="" method="post">
				<div class="ihc-stuffbox">
											...
											<td>
												<?php 
													if($v['name']=='ihc_social_media' || $v['name']=='payment_select'){
														...
														?>
														<input type="checkbox" onClick="check_and_h(this, '#ihc-field-display-admin<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_admin']) echo 'checked';?> <?php echo $global_disabled;?> />
											...
											<td>
												<?php 
													if ($v['display_public_reg']==2){
														...
														?>
														<input type="checkbox" onClick="check_and_h(this, '#ihc-field-display-public-reg<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_public_reg']) echo 'checked';?> <?php echo $global_disabled;?> />
											...
											<td>
												<?php 
													if ($v['display_public_ap']==2){
														...
														?>
														<input type="checkbox" onClick="check_and_h(this, '#ihc-field-display-public-ap<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_public_ap']) echo 'checked';?> <?php echo $global_disabled;?> />
											...
											<td>
												<?php 
													if ($v['display_public_reg']==2){
														...
														?>
														<input type="checkbox" onClick="check_and_h(this, '#ihc-require-<?php echo $k;?>');" <?php if ($v['req']) echo 'checked';?> id="req-check-<?php echo $k;?>" <?php echo $global_disabled;?>/>
