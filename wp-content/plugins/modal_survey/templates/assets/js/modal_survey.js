...
$.extend( Plugin.prototype, {
		...
		if ( ! thisanswer.hasClass( ".survey_rating" ) ) {
			...
			if ( ( survey_qoptions[ pq ][ 0 ] > 1 || survey.questions[ pq ][ 'hasopen' ] == true || survey.display == 'all' ) || survey_options[ 152 ] == 1 && ( survey_qoptions[ pq ][ 3 ] != '1' ) ) {
				if ( ! thisanswer.hasClass( "survey_open_answers" ) && survey_qoptions[ pq ][ 0 ] < 2 ) {
