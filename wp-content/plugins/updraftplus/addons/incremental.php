...
class UpdraftPlus_Addons_Incremental {
	 ...
	 */
	public function incremental_backup_link($link) {
	...
	public function incremental_cell($selected_interval) {
		...
		<?php echo '<a href="' . apply_filters('updraftplus_com_link', "https://updraftplus.com/support/tell-me-more-about-incremental-backups/") . '" target="_blank">' . __('Tell me more', 'updraftplus') . '</a>'; ?>
		</div>
		<?php
	}
	 ...
	 */
	public function prepare_incremental_run($incremental = false, $entities = array()) {
		global $updraftplus;
