	...
	public function get_configuration_middlesection_template() {
		...
		?>
			<tr class="<?php echo $classes; ?>">
				...
				<td>
					<input data-updraft_settings_test="url" type="text" class="updraft_input--wide" <?php $this->output_settings_field_name_and_id('url');?> value="{{url}}" readonly />
					<p>
			...
			<tr class="<?php echo $classes; ?>">
				...
				<td>
					<input type="number" step="1" min="1" max="65535" <?php $this->output_settings_field_name_and_id('port');?> class="updraft_webdav_settings updraft_input--wide" value="{{port}}" />
					<br>
