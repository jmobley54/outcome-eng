...
class tmnf_featured_widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		?>
			...
			<h2 class="widget widget-single inn"><a href="<?php echo esc_url(get_category_link($categories)); ?>"><?php echo esc_html($title); ?></a></h2>
			...
			<li class="fblock">
                    ...
                    <h3><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php echo tmnf_icon() ?> <?php echo short_title('...', 11); ?></a></h3>
                    <p class="meta">
