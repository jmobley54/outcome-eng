...
class Facebook_Widget extends WP_Widget {
	...
	{
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => '', 'width' => '285', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
		...
		<p>
			...
			<input class="widefat" style="width: 30px;" id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" value="<?php echo esc_attr($instance['width']); ?>" />
		</p>
