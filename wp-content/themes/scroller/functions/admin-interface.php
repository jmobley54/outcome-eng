...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "typography":
			...
			if (strpos($val, 'Lora') !== false){ $font28 = 'selected="selected"'; }
			...
			if (strpos($val, 'Kaushan Script') !== false){ $font59 = 'selected="selected"'; }

			if (strpos($val, 'Cinzel') !== false){ $font60 = 'selected="selected"'; }

			if (strpos($val, 'Yeseva One') !== false){ $font61 = 'selected="selected"'; }

			if (strpos($val, 'Halant') !== false){ $font62 = 'selected="selected"'; }

			if (strpos($val, 'Rozha One') !== false){ $font63 = 'selected="selected"'; }

			if (strpos($val, 'Hind') !== false){ $font64 = 'selected="selected"'; }

			if (strpos($val, 'Karma') !== false){ $font65 = 'selected="selected"'; }

			if (strpos($val, 'Slabo 13px') !== false){ $font66 = 'selected="selected"'; }

			if (strpos($val, 'Noto Sans') !== false){ $font67 = 'selected="selected"'; }

			if (strpos($val, 'Noto Serif') !== false){ $font68 = 'selected="selected"'; }

			if (strpos($val, 'Ek Mukta') !== false){ $font69 = 'selected="selected"'; }

			if (strpos($val, 'Source Serif Pro') !== false){ $font70 = 'selected="selected"'; }

			if (strpos($val, 'Old Standard TT') !== false){ $font71 = 'selected="selected"'; }

			if (strpos($val, 'Cardo') !== false){ $font72 = 'selected="selected"'; }
			...
			$output .= '<select class="themnific-typography themnific-typography-face" name="'. esc_attr( $value['id'].'_face' ) . '" id="'. esc_attr( $value['id'].'_face') . '">';
			...
			$output .= '<option value="Lora"'. $font28 .'>Lora***</option>';
			...
			$output .= '<option value="Kaushan Script"'. $font59 .'>Kaushan Script***</option>';

			$output .= '<option value="Cinzel"'. $font60 .'>Cinzel***</option>';

			$output .= '<option value="Yeseva One"'. $font61 .'>Yeseva One***</option>';

			$output .= '<option value="Halant"'. $font62 .'>Halant***</option>';

			$output .= '<option value="Rozha One"'. $font63 .'>Rozha One***</option>';

			$output .= '<option value="Hind"'. $font64 .'>Hind***</option>';

			$output .= '<option value="Karma"'. $font65 .'>Karma***</option>';

			$output .= '<option value="Slabo 13px"'. $font66 .'>Slabo 13px***</option>';

			$output .= '<option value="Noto Sans"'. $font67 .'>Noto Sans***</option>';

			$output .= '<option value="Noto Serif"'. $font68 .'>Noto Serif***</option>';

			$output .= '<option value="Ek Mukta"'. $font69 .'>Ek Mukta***</option>';

			$output .= '<option value="Source Serif Pro"'. $font70 .'>Source Serif Pro***</option>';

			$output .= '<option value="Old Standard TT"'. $font71 .'>Old Standard TT***</option>';

			$output .= '<option value="Cardo"'. $font72 .'>Cardo***</option>';
