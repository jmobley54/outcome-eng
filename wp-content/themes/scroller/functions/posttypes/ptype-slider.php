<?php 
//Custom Post Types
add_action('init', 'create_myslidertype');
function create_myslidertype() {
    $myslidertype_args = array(
        'label' => __('Slider','themnific'),
        'singular_label' => __('Slider','themnific'),
        'public' => true,
        'show_ui' => true,
		'menu_position' => 100,
  ...
  register_post_type('myslidertype',$myslidertype_args);
}
	


// Displays post image attachment (sizes: thumbnail, medium, full)
function dp_attachment_image2($postid=0, $size='Large', $attributes='title') {
...
$meta_boxes[] = array(
	...
	'pages' => array('myslidertype'), // multiple post types
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		...
		array(
            'name' => 'Video code',
            'desc' => 'You can put video (embed) here.',
