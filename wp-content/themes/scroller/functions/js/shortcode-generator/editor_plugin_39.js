    ...
    tinymce.PluginManager.add( 'ThemnificShortcodes', function( editor, url ) {
        ...
        editor.addButton( 'Themnific_shortcodes_button', {
			...
			menu: [
               	// Layout menu.
                {text: 'Layout', menu: [
                	{text: 'Portfolio Featured', onclick: function() { editor.execCommand( 'tmnf_open_dialog', false, 'portfolio_featured', { title: 'Portfolio Featured' } ); } },
                	{text: 'Portfolio Latest', onclick: function() { editor.execCommand( 'tmnf_open_dialog', false, 'portfolio_latest', { title: 'Portfolio Latest' } ); } },
                	...
                	{text: 'Slider Featured', onclick: function() { editor.execCommand( 'tmnf_open_dialog', false, 'slider_featured', { title: 'Slider Featured' } ); } },
                	...
                	{text: 'Staff', onclick: function() { editor.execCommand( 'insert_immediate', false, 'staff', { title: 'Staff' } ); } },
                	{text: 'Pricing Tabs 3col', onclick: function() { editor.execCommand( 'insert_immediate', false, 'pricing_tabs3', { title: 'Pricing Tabs 3col' } ); } },
                	{text: 'Pricing Tabs 4col', onclick: function() { editor.execCommand( 'insert_immediate', false, 'pricing_tabs4', { title: 'Pricing Tabs 4col' } ); } },
                	{text: 'Clients', onclick: function() { editor.execCommand( 'insert_immediate', false, 'clients', { title: 'Clients' } ); } },
                ]},
