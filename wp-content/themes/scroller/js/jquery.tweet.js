(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["Dannci"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      avatar_size: 35,                      // [integer]  height and width of avatar if displayed (48px max)
    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var date = '<a href="http://twitter.com/'+item.from_user+'/statuses/'+item.id+'" class="view-twitter slant">'+relative_time(item.created_at)+'</a>';
